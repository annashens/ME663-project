...
c Face Flux for U-CV at (i,j):
      ...
      AEU(1) = (1/RE)*DY/DX + MAX(0.0, -FEU(1))
      AWU(1) = (1/RE)*DY/DX + MAX(0.0, FWU(1))
      ANU(1) = (1/RE)*DX/DY + MAX(0.0, -FNU(1))
      ASU(1) = (1/RE)*DX/DY + MAX(0.0, FSU(1))
      APU(1) = 2*(1/RE)*DX/DY + 2*(1/RE)*DY/DX
     &    + MAX(0.0, FEU(1)) + MAX(0.0, FNU(1))
     &    + MAX(0.0, -FSU(1)) + MAX(0.0, -FWU(1))
...
c
      ...
      AEU(0) = (1/RE)*DY/DX + MAX(0.0, -FEU(0))
      AWU(0) = (1/RE)*DY/DX + MAX(0.0, FWU(0))
      ANU(0) = (1/RE)*DX/DY + MAX(0.0, -FNU(0))
      ASU(0) = (1/RE)*DX/DY + MAX(0.0, FSU(0))
      APU(0) = 2*(1/RE)*DX/DY + 2*(1/RE)*DY/DX
     &    + MAX(0.0, FEU(0)) + MAX(0.0, FNU(0))
     &    + MAX(0.0, -FSU(0)) + MAX(0.0, -FWU(0))
...
c
      ...
      AEV(1) = (1/RE)*DY/DX + MAX(0.0, -FEV(1))
      AWV(1) = (1/RE)*DY/DX + MAX(0.0, FWV(1))
      ANV(1) = (1/RE)*DX/DY + MAX(0.0, -FNV(1))
      ASV(1) = (1/RE)*DX/DY + MAX(0.0, FSV(1))
      APV(1) = 2*(1/RE)*DX/DY + 2*(1/RE)*DY/DX
     &    + MAX(0.0, FEV(1)) + MAX(0.0, FNV(1))
     &    + MAX(0.0, -FSV(1)) + MAX(0.0, -FWV(1))
...
c
      ...
      AEV(0) = (1/RE)*DY/DX + MAX(0.0, -FEV(0))
      AWV(0) = (1/RE)*DY/DX + MAX(0.0, FWV(0))
      ANV(0) = (1/RE)*DX/DY + MAX(0.0, -FNV(0))
      ASV(0) = (1/RE)*DX/DY + MAX(0.0, FSV(0))
      APV(0) = 2*(1/RE)*DX/DY + 2*(1/RE)*DY/DX
     &    + MAX(0.0, FEV(0)) + MAX(0.0, FNV(0))
     &    + MAX(0.0, -FSV(0)) + MAX(0.0, -FWV(0))
